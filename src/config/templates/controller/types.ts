...
export interface ControllerHooks<T extends BaseModel, U extends BaseInput<T>> {
    ...
    afterCreate?: (item: T, context: ServiceContext, c: Context) => Promise<void> | void
    beforeUpdate?: (id: string, data: Partial<T>, context: ServiceContext, c: Context) => Promise<void> | void
    afterUpdate?: (id: string, data: Partial<T>, context: ServiceContext, c: Context) => Promise<void> | void
    beforeDelete?: (id: string, context: ServiceContext, c: Context) => Promise<void> | void
    afterDelete?: (id: string, context: ServiceContext, c: Context) => Promise<void> | void
}
